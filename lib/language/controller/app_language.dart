...
import '/language/utils/local_storage/local_storgae.dart';
...
class AppLanguage extends GetxController {
  ...
  void onInit() async {
    ...
    appLocale.value = await localStorage.languageSelected == null
  ...
  void changeLanguage(String type) async {
    LocalStorage localStorage = LocalStorage();
    stg.write(language, type == null ? Get.deviceLocale!.languageCode : type);
