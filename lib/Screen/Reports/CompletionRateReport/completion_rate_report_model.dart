class CompletionRateReportModel {
  bool? success;
  DataCompletionRateReport? dataCompletionRateReport;
  String? message;

  CompletionRateReportModel({this.success, this.dataCompletionRateReport, this.message});

  CompletionRateReportModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataCompletionRateReport = json['data'] != null ? new DataCompletionRateReport.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataCompletionRateReport != null) {
      data['data'] = this.dataCompletionRateReport!.toJson();
    }
...
class DataCompletionRateReport {
  int? userId;
  String? userFullname;
  String? userEmail;
  String? userName;
  ...
  DataCompletionRateReport.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
