...
import 'archived_documents_report_controller.dart';
import 'filter_model.dart';
import 'item_archived_documents_report.dart';

class ArchivedDocumentsReportScreen extends StatefulWidget {

  var show_tabBar;
  var IsHome;
ArchivedDocumentsReportScreen({this.show_tabBar,    this.IsHome,});
  @override
  State<ArchivedDocumentsReportScreen> createState() => _KeeperCovenantScreenState();
}

class _KeeperCovenantScreenState extends State<ArchivedDocumentsReportScreen> {
  final controller = Get.put(ArchivedDocumentsReportController());
  ...
  Widget build(BuildContext context) {
    ...
    return
      ...
      Scaffold(
        appBar:  MyAppBar(
            title: '  تقرير المستندات المؤرشفة'.tr,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                GetBuilder<ArchivedDocumentsReportController>(
                    init: ArchivedDocumentsReportController(),
                    builder: (co) {
                      return InkWell(
                          onTap: () async {
  ...
  onClickSessionsType(
      ArchivedDocumentsReportController controller,
    ...
    Get.bottomSheet(
      Container(
        ...
        child: SingleChildScrollView(
          ...
          child: GetBuilder<ArchivedDocumentsReportController>(
              init: ArchivedDocumentsReportController(),
              builder: (buld) {
                return Column(
