class KeeperCovenantModel {
  bool? success;
  DataKeeperCovenant? dataKeeperCovenant;
  String? message;

  KeeperCovenantModel({this.success, this.dataKeeperCovenant, this.message});

  KeeperCovenantModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataKeeperCovenant = json['data'] != null ? new DataKeeperCovenant.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataKeeperCovenant != null) {
      data['data'] = this.dataKeeperCovenant!.toJson();
    }
...
class DataKeeperCovenant {
  ...
  DataKeeperCovenant.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
