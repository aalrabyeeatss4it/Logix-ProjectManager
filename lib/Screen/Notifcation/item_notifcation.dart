              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                    CustomRowText(text:'Registration number'.tr,textStyle: TextStyle(fontSize: 12,   fontFamily: 'Regular', color:kColorsPrimary , fontWeight: FontWeight.w500,),textValue: data.codeFormat==null?"":data.codeFormat.toString(),textValueStyle: TextStyle(fontSize: 10,    fontFamily: 'Regular',color: kColorsBlack,),backColor: kColorsWhite,),
                    CustomRowText(text:'The Topic'.tr,textStyle: TextStyle(fontSize: 12, color:kColorsPrimary ,   fontFamily: 'Regular', fontWeight: FontWeight.w500,),textValue: data.subject==null?"":data.subject.toString(),textValueStyle: TextStyle(fontSize: 10, color: kColorsBlack,),backColor: kColorsWhite,),
