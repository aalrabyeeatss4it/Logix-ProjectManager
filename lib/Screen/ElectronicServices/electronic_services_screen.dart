...
class ElectronicServicesScreen extends StatefulWidget {
  ...
  var show_tabBar;
  var IsHome;
  ElectronicServicesScreen({this.show_tabBar,    this.IsHome,});
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return
      Scaffold(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      buildContainer('تحديث الخطة الزمنية'.tr,kColorsBlack,kColorsWhite,(){Get.toNamed(RoutingApp.add_update_plan_screen);}),
                  ...
                  Row(
                    children: [
                      buildContainer('طلب صرف مواد لمشروع'.tr,kColorsBlack,kColorsWhite,(){Get.toNamed(RoutingApp.add_request_exchang_screen);}),
                      buildContainer('طلب شراء مواد لمشروع'.tr,kColorsBlack,kColorsWhite,(){Get.toNamed(RoutingApp.add_request_purchase_screen);}),
        ...
        bottomNavigationBar:widget.IsHome==true? Container(width: double.infinity,height: 0.00.sh,)
