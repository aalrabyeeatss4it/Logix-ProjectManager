...
import 'add_archive_document_project_controller.dart';

class AddArchiveDocumentProjectScreen extends StatefulWidget {

  var show_tabBar;
  AddArchiveDocumentProjectScreen({this.show_tabBar});
  @override
  State<AddArchiveDocumentProjectScreen> createState() => _AddArchiveDocumentProjectScreenState();
}

class _AddArchiveDocumentProjectScreenState extends State<AddArchiveDocumentProjectScreen> {
  final controller = Get.put(AddArchiveDocumentProjectController());
  ...
  Widget build(BuildContext context) {
    ...
    return
      Scaffold(
        appBar:  MyAppBar(
            title: 'ارشفة المستندات للمشروع'.tr,
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          GetBuilder<AddArchiveDocumentProjectController>(
                              init: controller,
                              builder: (co) {
                                return InkWell(
                                    onTap: () async {
  ...
  onClickTypeMasroff(AddArchiveDocumentProjectController controller, BuildContext context,       List<DataFilter> drop,) {
    Get.bottomSheet(
      StatefulBuilder(
          builder: (context, setState) {
            return
              Container(
                ...
                child: GetBuilder<AddArchiveDocumentProjectController>(
                  init: controller,
                  builder: (_c) {
                    return SizedBox(
                      height: 0.60.sh,
