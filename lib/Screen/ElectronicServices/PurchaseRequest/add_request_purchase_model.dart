class AddPurchaseRequestModel {
  bool? success;
  DataAddPurchaseRequest? dataAddPurchaseRequest;
  String? message;

  AddPurchaseRequestModel({this.success, this.dataAddPurchaseRequest, this.message});

  AddPurchaseRequestModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddPurchaseRequest = json['data'] != null ? new DataAddPurchaseRequest.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddPurchaseRequest != null) {
      data['data'] = this.dataAddPurchaseRequest!.toJson();
    }
...
class DataAddPurchaseRequest {
  ...
  DataAddPurchaseRequest.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
