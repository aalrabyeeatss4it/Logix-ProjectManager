class AddLessonsProjectModel {
  bool? success;
  DataAddLessonsProject? dataAddLessonsProject;
  String? message;

  AddLessonsProjectModel({this.success, this.dataAddLessonsProject, this.message});

  AddLessonsProjectModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddLessonsProject = json['data'] != null ? new DataAddLessonsProject.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddLessonsProject != null) {
      data['data'] = this.dataAddLessonsProject!.toJson();
    }
...
class DataAddLessonsProject {
  ...
  DataAddLessonsProject.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
