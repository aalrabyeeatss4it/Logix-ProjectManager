...
import 'add_request_exchange_controller.dart';

class ItemsExchangRequestScreen extends StatefulWidget {

  var show_tabBar;
  ItemsExchangRequestScreen({this.show_tabBar});
  @override
  State<ItemsExchangRequestScreen> createState() => _ItemsExchangRequestScreenState();
}

class _ItemsExchangRequestScreenState extends State<ItemsExchangRequestScreen> {
