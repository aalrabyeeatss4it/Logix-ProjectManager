class ReportsModel {
  ...
  ReportsModel({this.success, this.dataReports, this.message});

  ReportsModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataReports = json['data'] != null ? new DataReports.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataReports != null) {
      data['data'] = this.dataReports!.toJson();
    }
