class UpdatePlanModel {
  bool? success;
  DataUpdatePlan? dataUpdatePlan;
  String? message;

  UpdatePlanModel({this.success, this.dataUpdatePlan, this.message});

  UpdatePlanModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataUpdatePlan = json['data'] != null ? new DataUpdatePlan.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataUpdatePlan != null) {
      data['data'] = this.dataUpdatePlan!.toJson();
    }
...
class DataUpdatePlan {
  ...
  DataUpdatePlan.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
