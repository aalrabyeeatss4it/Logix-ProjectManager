class ElectronicServicesModel {
  bool? success;
  DataElectronicServices? dataElectronicServices;
  String? message;

  ElectronicServicesModel({this.success, this.dataElectronicServices, this.message});

  ElectronicServicesModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataElectronicServices = json['data'] != null ? new DataElectronicServices.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataElectronicServices != null) {
      data['data'] = this.dataElectronicServices!.toJson();
    }
...
class DataElectronicServices {
  ...
  DataElectronicServices.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
