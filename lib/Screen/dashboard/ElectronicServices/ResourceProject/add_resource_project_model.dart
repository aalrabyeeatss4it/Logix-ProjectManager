class AddResourceProjectModel {
  bool? success;
  DataAddResourceProject? dataAddResourceProject;
  String? message;

  AddResourceProjectModel({this.success, this.dataAddResourceProject, this.message});

  AddResourceProjectModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddResourceProject = json['data'] != null ? new DataAddResourceProject.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddResourceProject != null) {
      data['data'] = this.dataAddResourceProject!.toJson();
    }
...
class DataAddResourceProject {
  ...
  DataAddResourceProject.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
