class RequestCovenantModel {
  bool? success;
  DataRequestCovenant? dataRequestCovenant;
  String? message;

  RequestCovenantModel({this.success, this.dataRequestCovenant, this.message});

  RequestCovenantModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataRequestCovenant = json['data'] != null ? new DataRequestCovenant.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataRequestCovenant != null) {
      data['data'] = this.dataRequestCovenant!.toJson();
    }
...
class DataRequestCovenant {
  ...
  DataRequestCovenant.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
