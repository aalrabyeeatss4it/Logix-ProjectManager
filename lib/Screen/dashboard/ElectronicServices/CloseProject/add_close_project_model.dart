class AddCloseProjectModel {
  bool? success;
  DataAddCloseProject? dataAddCloseProject;
  String? message;

  AddCloseProjectModel({this.success, this.dataAddCloseProject, this.message});

  AddCloseProjectModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddCloseProject = json['data'] != null ? new DataAddCloseProject.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddCloseProject != null) {
      data['data'] = this.dataAddCloseProject!.toJson();
    }
...
class DataAddCloseProject {
  ...
  DataAddCloseProject.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
