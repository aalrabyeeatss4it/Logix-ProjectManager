class AddArchiveDocumentProjectModel {
  bool? success;
  DataAddArchiveDocumentProject? dataAddArchiveDocumentProject;
  String? message;

  AddArchiveDocumentProjectModel({this.success, this.dataAddArchiveDocumentProject, this.message});

  AddArchiveDocumentProjectModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddArchiveDocumentProject = json['data'] != null ? new DataAddArchiveDocumentProject.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddArchiveDocumentProject != null) {
      data['data'] = this.dataAddArchiveDocumentProject!.toJson();
    }
...
class DataAddArchiveDocumentProject {
  int? userId;
  String? userFullname;
  String? userEmail;
  String? userName;
  ...
  DataAddArchiveDocumentProject.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
