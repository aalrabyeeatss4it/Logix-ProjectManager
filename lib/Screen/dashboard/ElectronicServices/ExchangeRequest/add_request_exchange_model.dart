class AddRequestExchangeModel {
  bool? success;
  DataAddRequestExchange? dataAddRequestExchange;
  String? message;

  AddRequestExchangeModel({this.success, this.dataAddRequestExchange, this.message});

  AddRequestExchangeModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddRequestExchange = json['data'] != null ? new DataAddRequestExchange.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddRequestExchange != null) {
      data['data'] = this.dataAddRequestExchange!.toJson();
    }
...
class DataAddRequestExchange {
  ...
  DataAddRequestExchange.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
