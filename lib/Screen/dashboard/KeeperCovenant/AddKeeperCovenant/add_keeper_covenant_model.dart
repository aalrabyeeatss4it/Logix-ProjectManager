class AddKeeperCovenantModel {
  bool? success;
  DataAddKeeperCovenant? dataAddKeeperCovenant;
  String? message;

  AddKeeperCovenantModel({this.success, this.dataAddKeeperCovenant, this.message});

  AddKeeperCovenantModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataAddKeeperCovenant = json['data'] != null ? new DataAddKeeperCovenant.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataAddKeeperCovenant != null) {
      data['data'] = this.dataAddKeeperCovenant!.toJson();
    }
...
class DataAddKeeperCovenant {
  ...
  DataAddKeeperCovenant.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
