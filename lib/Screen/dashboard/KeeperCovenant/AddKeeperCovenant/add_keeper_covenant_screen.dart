                          ...
                          Row(
                            children: [
                              Container(
                                  ...
                                  child: Text(
                                    "المرفقات".tr,
                                    style: TextStyle(   fontFamily: 'GraphikArabic',color:kColorsPrimaryFont,fontSize: 12,fontWeight: FontWeight.w500),)
                              ),
                            ],
                          ),
                          SizedBox(
                          ...
                          Row(
                            children: [
                              Container(
                                  ...
                                  child: Text(
                                    "مسار الملف".tr,
                                    style: TextStyle(   fontFamily: 'GraphikArabic',color:kColorsBlackTow,fontSize: 14),)
                              ),
                            ],
                          ),
                          SizedBox(
