class FinancialInformationModel {
  bool? success;
  List<DataFinancialInformation>? dataFinancialInformation;
  String? message;

  FinancialInformationModel({this.success, this.dataFinancialInformation, this.message});

  FinancialInformationModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      dataFinancialInformation = <DataFinancialInformation>[];
      json['data'].forEach((v) {
        dataFinancialInformation!.add(new DataFinancialInformation.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataFinancialInformation != null) {
      data['data'] = this.dataFinancialInformation!.map((v) => v.toJson()).toList();
    }
    data['message'] = this.message;
    return data;
  }
}
class DataFinancialInformation {
  String? depCode;
  String? depName;
  int? code;
  String? hDate;
  ...
  DataFinancialInformation.fromJson(Map<String, dynamic> json) {
