class TasksPerformedModel {
  bool? success;
  List<DataTasksPerformed>? dataTasksPerformed;
  String? message;

  TasksPerformedModel({this.success, this.dataTasksPerformed, this.message});

  TasksPerformedModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      dataTasksPerformed = <DataTasksPerformed>[];
      json['data'].forEach((v) {
        dataTasksPerformed!.add(new DataTasksPerformed.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataTasksPerformed != null) {
      data['data'] = this.dataTasksPerformed!.map((v) => v.toJson()).toList();
    }
    data['message'] = this.message;
    return data;
  }
}
class DataTasksPerformed {
  String? depCode;
  String? depName;
  int? code;
  String? hDate;
  ...
  DataTasksPerformed.fromJson(Map<String, dynamic> json) {
