class TechnicalInformationModel {
  bool? success;
  List<DataTechnicalInformation>? dataTechnicalInformation;
  String? message;

  TechnicalInformationModel({this.success, this.dataTechnicalInformation, this.message});

  TechnicalInformationModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      dataTechnicalInformation = <DataTechnicalInformation>[];
      json['data'].forEach((v) {
        dataTechnicalInformation!.add(new DataTechnicalInformation.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataTechnicalInformation != null) {
      data['data'] = this.dataTechnicalInformation!.map((v) => v.toJson()).toList();
    }
    data['message'] = this.message;
    return data;
  }
}
class DataTechnicalInformation {
  String? depCode;
  String? depName;
  int? code;
  String? hDate;
  ...
  DataTechnicalInformation.fromJson(Map<String, dynamic> json) {
