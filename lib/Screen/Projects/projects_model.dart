class ProjectsModel {
  ...
  ProjectsModel({this.success, this.dataProjects, this.message});

  ProjectsModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    dataProjects = json['data'] != null ? new DataProjects.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataProjects != null) {
      data['data'] = this.dataProjects!.toJson();
    }
