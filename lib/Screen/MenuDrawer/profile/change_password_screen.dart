...
class _ChangPasswordScreenState extends State<ChangPasswordScreen> {
  ...
  final  zDChangPasswordController=ZoomDrawerController();
  ...
  Widget build(BuildContext context) {
    ...
    return   GestureDetector(
      onTap: () {
        ...
        zDChangPasswordController.toggle!(); // أو zDMemberController.close!(); إذا كنت تريد الإغلاق فقط
      },
      child: Scaffold(
        backgroundColor: kColorsWhite,
        body: Obx(() => SafeArea(
          child: ZoomDrawer(isRtl:isRtl?true: false,
            controller: zDChangPasswordController,
            style:DrawerStyle.style1,
            menuScreen: MenuWidgetDachbord(zoomDrawerController: zDChangPasswordController,),
            mainScreen: Scaffold(
              appBar:  MyAppBar(title:    "change password".tr,zoomDrawerController: zDChangPasswordController,colorfont:kColorsWhite ),
              backgroundColor: kColorsWhite,
              body: Container(
